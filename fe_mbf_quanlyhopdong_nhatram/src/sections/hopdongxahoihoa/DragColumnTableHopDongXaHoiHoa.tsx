...
export default function DragColumnTableHopDongXaHoiHoa({
  open,
  onClose,
  title,
  data,
  ...
  const onDragEnd = (result: DropResult) => {
    ...
    localStorage.setItem(DRAG_HOP_DONG_XA_HOI_HOA_COL, JSON.stringify(reorderedItems));
  ...
  const handleToggleChecked = (itemId: string) => {
    ...
    localStorage.setItem(DRAG_HOP_DONG_XA_HOI_HOA_COL, JSON.stringify(updatedItems));
    setItems(updatedItems);
    onDragColumn(updatedItems);
  };
  useEffect(() => {
    const localStorageValue = localStorage.getItem(DRAG_HOP_DONG_XA_HOI_HOA_COL);
