...
export const HOP_DONG_IBC = 'hop-dong-ibc';
export const TABLE_HEAD_HOP_DONG_IBC: IHead[] = [
  {
    id: 'soHopDong',
    value: 'soHopDong',
    label: 'Số hợp đồng',
...
export const HEAD_HOP_DONG_IBC_TRAM_LIST: IHead[] = [
  {
    id: 'tram.maTram',
    value: 'tram.maTram',
    label: 'Mã trạm',
...
export const HEAD_HOP_DONG_IBC_TRAM_LIST_COLLAPSE: IHead[] = [
  {
    id: 'tram.maTram',
    value: 'tram.maTram',
    label: 'Mã trạm',
...
export const COLUMN_MAPPING_HOP_DONG_IBC: IColumnMapping = {
  '6': 'dongSo',
  'Số HĐ (*)': 'soHopDong',
...
export const TABLE_HEAD_IMPORT_HOP_DONG_IBC: IHead[] = [
...
export const TABLE_HEADER_IMPORT_HOP_DONG_IBC_GROUP_COLUMN: IHeadGroupColumn[] = [
  {
    id: 'thongTinHopDong',
    colSpan: 36,
...
export const TABLE_HEADER_IMPORT_HOP_DONG_IBC_GROUP_COLUMN_DATA_VALID: IHeadGroupColumn[] = [
  {
    id: 'thongTinHopDong',
    colSpan: 35,
    label: 'Thông tin hợp đồng',
...
export const DRAG_HOP_DONG_IBC_COL = 'dragColumnHopDongIbc';
...
export const HEAD_HOP_DONG_IBC_DA_GUI_PHE_DUYET: IHead[] = [
  {
...
const temp = HEAD_HOP_DONG_IBC_TRAM_LIST.slice(0, endDetailHeadThongTinTram);

export const HEAD_HOP_DONG_IBC_THONG_TIN_TRAM_DETAIL: IHead[] = [...temp];
