...
const CreateHopDongXaHoiHoaProvider = ({ children }: AppProps) => {
...
const useCreateHopDongXaHoiHoaContext = () => {
  const context = React.useContext(Context);
  if (context === undefined) {
    throw new Error(
      'useCreateHopDongXaHoiHoaContext must be used within a CreateHopDongXaHoiHoaProvider'
    );
  }
  return context;
};

export { CreateHopDongXaHoiHoaProvider, useCreateHopDongXaHoiHoaContext };
