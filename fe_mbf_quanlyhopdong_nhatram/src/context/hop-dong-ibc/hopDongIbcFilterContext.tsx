...
const HopDongIbcFilterProvider = ({ children }: AppProps) => {
...
const useHopDongIbcFilterContext = () => {
  const context = React.useContext(Context);
  if (context === undefined) {
    throw new Error('useHopDongIbcFilterContext must be used within a HopDongIbcFilterProvider');
  }
  return context;
};

export { HopDongIbcFilterProvider, useHopDongIbcFilterContext };
